    ...
    <div className="space-y-6">
      ...
      <div className="grid md:grid-cols-3 gap-6">
        <div className="md:col-span-1 glass-panel p-6 self-start">
          <h3 className="text-lg font-bold text-green-900 dark:text-green-100 mb-4">Generate New Code</h3>
              ...
              <tbody>
                {codes?.map(c => (
                  <tr key={c.code} className="border-b border-green-100 dark:border-green-900/50 hover:bg-white/40 dark:hover:bg-black/20">
                    <td className="p-4 font-mono font-bold text-green-800 dark:text-green-200">{c.code}</td>
